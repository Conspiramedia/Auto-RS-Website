    ...
    <div className="space-y-6">
      ...
      <Card>
        <div className="space-y-3">
          ...
          {/* Переход на ПУБЛИЧНУЮ страницу салона — синяя кнопка НАД
              зелёным сохранением, тем же порядком, что в форме
              профиля: зелёный на сайте занят главным действием
              экрана, а главное здесь — сохранить. Настоящая ссылка
              (Button с href), чтобы страницу можно было открыть в
              новой вкладке и сравнить, не потеряв несохранённое.

              Подпись НЕ «Моя витрина»: этой надписью названа кнопка в
              профиле, которая ведёт сюда, в редактор. Две кнопки с
              одинаковым текстом, ведущие в разные места, читались бы
              как ошибка — поэтому здесь сказано прямо, куда попадёт
              продавец: на страницу, которую видят покупатели. */}
          <Button
