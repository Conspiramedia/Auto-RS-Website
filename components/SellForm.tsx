...
export default function SellForm({
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // проходил serbianPhoneToE164, и правка падала на шаге verify
  ...
  async function submit() {
    ...
    try {
      ...
      if (isEdit || signedIn) {
        ...
        // отклонён — но уже невнятной ошибкой из PostgREST.
        //
        // Текст именно про НОМЕР, а не про код подтверждения. Раньше
        // здесь бросался otp_err_failed («Не удалось подтвердить код»),
        // и в режиме правки это сбивало с толку полностью: никакого
        // кода форма не запрашивает, а человек читал сообщение про
        // него и искал причину в SMS.
