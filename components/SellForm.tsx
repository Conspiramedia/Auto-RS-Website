  ...
  return (
    <Card>
      ...
      {/* Плашка ошибки для ОСТАЛЬНЫХ шагов. Ошибки показываются в ней
          ...
          У шага «Детали» своя плашка — прямо над кнопками (см. выше).
          Здесь он исключён, иначе одна ошибка печаталась бы дважды, а
          id="sell-error" оказался бы в документе в двух экземплярах и
          сломал бы aria-describedby у полей. */}
      {error && step !== 2 && (
