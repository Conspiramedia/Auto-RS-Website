...
export default function SellForm({
  ...
  // ПЛАШКА ГАСНЕТ, КАК ТОЛЬКО ЧЕЛОВЕК ВЗЯЛСЯ ЗА ПОЛЕ.
  //
  ...
  //
  // Зависимости — все поля шага, а не одно описание: правило общее,
  // и гасить плашку только на описании значило бы объяснять
  // пользователю разницу, которой он не видит.
  //
  // ТОЛЬКО НА ШАГЕ 2. Без этой проверки эффект гасил бы и чужие
  // ошибки: при правке объявления загрузка заполняет все поля разом
  // (и стёрла бы «Не удалось загрузить объявление»), а на шаге
  // контактов сообщение о неудачной публикации пропало бы от любого
