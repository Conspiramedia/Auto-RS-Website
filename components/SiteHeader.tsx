...
// дилеры.
//
// «Приложение» (/app) убрано из ряда: мобильное приложение не выпущено,
// и раздел обещал бы посетителю продукт, которого нет. Маршрут и
// страница остаются в проекте — вернуть ссылку можно одной строкой.
//
