...
export default function ShareButton({ locale, url, title }: Props) {
  ...
  return (
    // Кнопка стоит в вертикальном стеке под «Продолжить в приложении»
    // и обязана совпадать с ней по ширине и размеру: две кнопки разной
    // ширины друг под другом читаются как сбитая вёрстка.
