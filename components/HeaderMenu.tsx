...
// neutral-60), справа — подпись. У активного пункта значок и подпись
// красятся brand-primary, слева появляется полоса 4px; у остальных
// та же полоса стоит прозрачной, иначе активный сдвигал бы текст.
//
//   ── блок аккаунта ───────────────────────────────
//   LogIn          Войти            только гостю, font-semibold
//   CarFront       Мои объявления   только вошедшему, font-semibold
//   MessageSquare  Сообщения        + счётчик справа
//   Bell           Уведомления      + счётчик справа
//   CircleUser     Профиль
//   ── действие над сайтом ─────────────────────────
//   Download       Быстрый доступ   font-semibold, отбит линиями
//   ── разделы сайта (font-medium) ─────────────────
//   Tag            Продажа
//   KeyRound       Аренда
...
// выход снизу — действие над аккаунтом.
//
// Значки — ui/NavIcons.tsx, кроме «Быстрого доступа»: там общий
// InstallIcon из ui/InstallIcons, тот же, что у шага инструкции на
// /install. Начертание: личный блок и «Быстрый доступ» полужирные
// (font-semibold), разделы сайта обычные (font-medium) — у активного
// раздела начертание поднимается до semibold, потому что одной сменой
// цвета подсветка читалась бы слабее, чем в личном блоке.
// ============================================================
