  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:py-12">
        ...
        {/* ИЛЛЮСТРАЦИЯ ПОД ПОДЗАГОЛОВКОМ — как на /about,
            /how-it-works и /faq.
            ------------------------------------------------------------
            Ниже идут реквизиты списком и форма обращения: страница из
            одних полей и адресов выглядит канцелярией, хотя её задача —
            позвать человека написать.

            Сюжет отвечает этой задаче прямо: облачка сообщений у
            телефона рядом с машиной. Стоит ДО реквизитов, а не между
            ними и формой: тому, кому нужен просто адрес почты, картинка
            не должна добавлять прокрутки к самому нужному.

            priority не ставится: выше заголовок и подзаголовок, ранняя
            загрузка отняла бы полосу у них. Область зарезервирована
            через aspect + fill — подгрузка не сдвигает реквизиты под
            картинкой.

            Пропорции 16/10 на узком экране и 21/9 с sm: страница
            max-w-3xl, и высокий кадр во всю ширину отодвинул бы
            контакты за сгиб.

            Пустой alt: изображение декоративное, смысл несут
            подзаголовок над ним и реквизиты под ним. */}
        <div className="relative mt-6 aspect-[16/10] overflow-hidden rounded-card sm:aspect-[21/9]">
          <Image
            src="/images/contact-messages.webp"
            alt=""
            fill
