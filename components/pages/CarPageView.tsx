      ...
      <main className="mx-auto max-w-6xl px-4 py-6 sm:py-8">
        ...
        <div className="grid gap-6 md:grid-cols-[minmax(0,2fr)_minmax(280px,1fr)]">
          <div className="min-w-0">
            ...
            {/* «НА ЗАКАЗ» (0118). Плашка стоит рядом с ценой, а не в
                характеристиках: это первое, что покупатель обязан
                узнать о предложении — машины сейчас нет, салон привезёт
                её под клиента. Узнав об этом после звонка, человек
                чувствует себя обманутым, даже если салон честен.

                Тон info-soft: сообщение о факте, а не оценка. Зелёный
                и золотой здесь читались бы как достоинство, красный —
                как проблема, тогда как это просто условие сделки.

                У проданного не показываем: сделка закрыта, и условия
                поставки уже ни на что не влияют. */}
            {car.is_on_order && car.status !== 'sold' && (
