    ...
    >
      ...
      <div aria-hidden="true" className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          {/* leading-tight: у text-h3 собственный межстрочный интервал
              рассчитан на заголовок, и в паре с подписью цифра
              отрывалась бы от неё лишним просветом. */}
          <div className="text-h3 font-bold leading-tight text-neutral-100">
            {value}
          </div>

          {/* Подпись переносится, а не обрезается: «Объявления» на
              360px в колонку 156px не помещается в строку, а
              многоточие вместо второй строки скрыло бы смысл метрики.
              Резерва высоты (min-h) здесь больше НЕТ: карточки ряда
              растягиваются по самой высокой (items-stretch у сетки),
              и разная длина подписи ступеньки не создаёт. */}
