          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 py-12 sm:py-16 lg:grid-cols-2 lg:gap-12">
            <div>
              {/* РАЗМЕР ЗАГОЛОВКА НА УЗКОМ ЭКРАНЕ ЗАДАН ЯВНО.
                  ...
                  При нижней границе 26px фраза срывается на три строки
                  уже на 320px, поэтому потолок здесь 24px: это
                  максимум, при котором две строки держатся на всех
                  ходовых ширинах, включая самую узкую.
