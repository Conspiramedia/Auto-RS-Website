          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 py-12 sm:py-16 lg:grid-cols-2 lg:gap-12">
            <div>
              {/* РАЗМЕР ЗАГОЛОВКА НА УЗКОМ ЭКРАНЕ ЗАДАН ЯВНО.
                  ...
                  плавно растёт от 25px до 34px, и заголовок держится в
                  ...
                  Нижняя граница 25px — по решению заказчика. Это на
                  пункт выше расчётного предела для двух строк на
                  320px, поэтому на самых узких экранах заголовок может
                  занять три строки. Размен сознательный: на 320px
                  приходится доля процента заходов, а на ходовых
                  360-430px две строки сохраняются.
              ...
              <h1 className="max-w-2xl text-[clamp(1.5625rem,6.2vw,2.125rem)] font-bold leading-tight lg:text-display">
                {t('home_hero_title')}
              </h1>
