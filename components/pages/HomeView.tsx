          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 py-12 sm:py-16 lg:grid-cols-2 lg:gap-12">
            <div>
              {/* РАЗМЕР ЗАГОЛОВКА НА УЗКОМ ЭКРАНЕ ЗАДАН ЯВНО.
                  ...
                  РАЗМЕР ЗАДАН СТУПЕНЯМИ ШКАЛЫ, а не clamp. Здесь
                  стояла плавная функция от ширины экрана, и она честно
                  решала свою задачу — но подобранное значение всё
                  равно упиралось в 24px, то есть ровно в ступень h2.
                  Раз итог совпал со ступенью, произвольное значение
                  в разметке больше не оправдано: правило проекта —
                  размеры живут в токенах.

                  Три ступени по брейкпоинтам:
                    h2 (24px)      — телефон;
                    h1 (30px)      — с sm, где ширины уже хватает;
                    display (36px) — с lg, обложка первого экрана.

                  ПОЧЕМУ НА ТЕЛЕФОНЕ ИМЕННО h2. Заголовок вырос до 36
                  символов и содержит «автомобилей» (11 букв) — оно
                  одно занимает половину строки на узком экране. 24px
                  это предел, при котором фраза держится в две строки
                  на всех ходовых ширинах, включая 320px; 25 и 26px
                  пробовали, оба срывались на третью.
              ...
              <h1 className="max-w-2xl text-h2 font-bold leading-tight sm:text-h1 lg:text-display">
                {t('home_hero_title')}
              </h1>
