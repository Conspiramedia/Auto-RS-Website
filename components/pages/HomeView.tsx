          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 py-12 sm:py-16 lg:grid-cols-2 lg:gap-12">
            <div>
              {/* РАЗМЕР ЗАГОЛОВКА НА УЗКОМ ЭКРАНЕ ЗАДАН ЯВНО.
                  ...
                  clamp вместо ступени шкалы: между 320px и 480px размер
                  плавно растёт от 26px до 36px, и заголовок держится в
                  ...
                  Нижняя граница 26px — по решению заказчика,
                  подобрана по виду. Технический предел выше: на 320px
                  в две строки помещается до 30px, так что запас есть.
              ...
              <h1 className="max-w-2xl text-[clamp(1.625rem,7.8vw,2.25rem)] font-bold leading-tight lg:text-display">
                {t('home_hero_title')}
              </h1>
