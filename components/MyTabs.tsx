...
export default function MyTabs({ locale }: Props) {
  ...
  return (
    // overflow-x-auto: на 360px четыре вкладки в строку не помещаются,
    // и горизонтальная прокрутка лучше переноса — высота шапки кабинета
    // остаётся постоянной при переходах. С добавлением «Уведомлений»
    // прокрутка стала нужна и на 768px: четыре чипса с сербскими
    // подписями там уже на пределе ширины.
