...
export default function MyTabs({ locale }: Props) {
  ...
  return (
    ...
    // нужно четырём вкладкам, и не растягивается по контейнеру.
    ...
    // определяется текстом, и на планшете она заведомо помещается —
    // четыре подписи и раньше влезали, просто разной ширины.
