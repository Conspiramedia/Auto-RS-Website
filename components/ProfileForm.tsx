      ...
      <Card>
        <div className="space-y-3">
          ...
          {/* ПЕРЕХОД НА ВИТРИНУ — КНОПКА, А НЕ ССЫЛКА, И СТОИТ ЗДЕСЬ.
              ...
              ВЕДЁТ В РЕДАКТОР ВИТРИНЫ (/my/showcase), а не на публичную
              страницу салона. Прежде кнопка открывала готовую витрину —
              и это был тупик: продавец видел, что описания нет, а как
              его добавить, экран не объяснял никак. Теперь он попадает
              туда, где витрина ЗАПОЛНЯЕТСЯ, и правки сразу видны в
              превью; переход на публичную страницу есть там же, внутри
              редактора. */}
          {sellerKind === 'dealer' && (
            <Button
