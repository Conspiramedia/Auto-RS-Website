...
const ACTIONS: Record<string, { label: string; className: string }> = {
  ...
  // Ручное назначение уровня продавца (0144). Нейтральный тон
  // намеренно: это не поощрение и не наказание, а вмешательство в
  // расчёт, и читаться оно должно как пометка «здесь считали не по
  // формуле». Причина назначения лежит в payload и видна в карточке
  // пользователя.
  seller_tier_set: {
    label: 'Уровень продавца назначен вручную',
    className: 'text-neutral-70',
  },
  seller_tier_cleared: {
    label: 'Уровень продавца вернулся к расчёту',
    className: 'text-neutral-70',
  },
