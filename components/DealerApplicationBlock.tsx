      ...
      <div className="space-y-3">
        ...
        {!open ? (
          /* На мобильном кнопка занимает всю ширину карточки: это
             ...
             принадлежит главному действию экрана, а в профиле это
             сохранение данных. Заявка на статус салона — шаг в
             сторону, и синий ставит её на верный уровень, оставаясь
             при этом заметнее контурной secondary. */
          <Button
            variant="info"
            size="sm"
