...
попадут в каталог и sitemap. Запрос на удаление приведён в конце файла миграции.
...
- [ ] **Фото в демо-данных.** Сид создаёт объявления без изображений;
      для наглядной проверки вёрстки залить файлы в бакет `car-images`.
