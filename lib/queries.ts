...
// ------------------------------------------------------------
// Блок «Автосалоны на площадке» на главной. Отдаёт данные салона
// вместе с адресами фотографий его машин — одним запросом на весь
// блок, а не по вызову на плитку.
//
// Ошибку глушим: блок салонов на главной второстепенен рядом с
// витриной объявлений, и недоступная RPC не должна ронять страницу,
// которая к тому же генерируется статически. Пустой массив означает
// «блока нет» — ровно так же ведут себя витрины свежего и аренды.
