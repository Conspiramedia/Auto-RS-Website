...
export const dict = {
  sr: {
    ...
    // Гостю: телефон продавца RPC ему не отдаёт (0116), поэтому
    // кнопка ведёт на вход, а не показывает пустоту.
    car_call_login: 'Prijavite se da pozovete',
  ...
  ru: {
    ...
    car_call_login: 'Войдите, чтобы позвонить',
