...
const FAQ_SR: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Salon dobija posebnu stranicu sa celim voznim parkom na jednom mestu, pod svojim nazivom i naslovnom slikom. Svaki oglas vodi na tu stranicu, pa kupci odmah vide da imaju posla sa firmom, a ne sa privatnim licem.',
  },
];
...
const FAQ_RU: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Салон получает отдельную страницу со всем автопарком в одном месте, под своим названием и обложкой. Каждое объявление ведёт на эту страницу, поэтому покупатели сразу видят, что имеют дело с компанией, а не с частным лицом.',
  },
];
