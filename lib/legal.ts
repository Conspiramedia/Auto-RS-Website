...
// ============================================================
// ЕДИНЫЙ ИСТОЧНИК ИСТИНЫ для сайта. Русские тексты перенесены ДОСЛОВНО
// из приложения (lib/features/legal/policy_content.dart, константы
// kPrivacyPolicyBodyRu и kTermsBodyRu) — формулировки обязаны совпадать,
// иначе пользователь принимает на сайте и в приложении разные документы.
//
// В приложении текст существует ТОЛЬКО на русском. Сербская версия ниже —
// перевод тех же формулировок, сделанный для сайта: сербский здесь
...
const PRIVACY_SR: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Podatke obrađujemo isključivo radi izvršenja korisničkog ugovora, pružanja usluga Aplikacije i zaštite interesa Korisnika.',
      ...
      '• Komunikacija i obaveštenja: slanje obaveštenja, upita i informacija u vezi sa korišćenjem Aplikacije, kao i obrada zahteva Korisnika.',
      '• Bezbednost: sprečavanje prevara, spama, uvreda i drugih kršenja pravila Aplikacije.',
      '• Analitika: poboljšanje kvaliteta Aplikacije, njene upotrebljivosti i razvoj novih funkcija na osnovu anonimizovanih tehničkih podataka.',
    ],
  },
  {
    heading: '2. Spisak podataka koji se obrađuju',
    paragraphs: [
      'Aplikacija prikuplja i obrađuje sledeće kategorije podataka:',
      ...
      '• Tehnički podaci (jedinstveni identifikator uređaja, tip i model uređaja, verzija operativnog sistema, verzija Aplikacije, IP adresa, vreme pristupa).',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Aplikacija ima pravo da prenese podatke trećim licima u sledećim slučajevima:',
      '• Javni podaci: ime, avatar, broj telefona i sadržaj oglasa postaju dostupni drugim korisnicima Aplikacije radi zaključivanja poslova kupoprodaje i izdavanja automobila.',
      ...
      'Aplikacija se obavezuje da neće prodavati, iznajmljivati niti prenositi lične podatke Korisnika u marketinške svrhe trećim licima bez izričite saglasnosti.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'Korisnik ima pravo:',
      '• Na pristup i izmenu: da samostalno uređuje, ažurira ili ispravlja svoje lične podatke putem profila u Aplikaciji.',
      ...
      '• Na potpuno brisanje: da pošalje zahtev za potpuno brisanje naloga i svih sa njim povezanih ličnih podataka iz baza podataka Aplikacije.',
  ...
  },
  {
    ...
    paragraphs: [
      'Korisnik snosi punu i isključivu odgovornost za svaki sadržaj (tekstove oglasa, fotografije, opise, komentare i poruke) koji objavljuje ili prenosi putem Aplikacije.',
      ...
      'Aplikacija primenjuje automatsku moderaciju (proveru rečnikom i pomoću tehnologija veštačke inteligencije) radi otkrivanja zabranjenog sadržaja. Međutim, automatska moderacija ima pomoćni karakter i ne oslobađa Korisnika odgovornosti: prolazak oglasa kroz proveru ne znači saglasnost ili odobrenje njegovog sadržaja od strane Aplikacije.',
      'Aplikacija ima pravo da bez prethodnog obaveštenja odbije objavljivanje, sakrije ili ukloni svaki sadržaj koji krši ovu Politiku, kao i da blokira korisnički nalog Korisnika koji je prekršio pravila. Odgovornost za posledice objavljivanja zabranjenog sadržaja, uključujući zahteve trećih lica i nadležnih organa, snosi neposredno Korisnik koji je takav sadržaj objavio.',
    ],
  },
  {
    heading: '7. Izmena Politike privatnosti',
    paragraphs: [
      'Zadržavamo pravo da menjamo ovu Politiku. Nova verzija stupa na snagu od trenutka njenog objavljivanja u Aplikaciji, osim ako novom verzijom Politike nije drugačije predviđeno. Pri unošenju bitnih izmena koje utiču na prava Korisnika, Aplikacija se obavezuje da o tome obavesti (na primer, putem iskačućeg prozora) i zatraži ponovnu saglasnost.',
    ],
  },
  {
...
const TERMS_RU: LegalSection[] = [
  ...
  {
    heading: '1. Предмет и статус Приложения',
    paragraphs: [
...
const TERMS_SR: LegalSection[] = [
  {
    paragraphs: [
      'Ovi Uslovi korišćenja (u daljem tekstu: „Uslovi“) uređuju odnose između Korisnika i Rukovaoca aplikacije „Auto RS“ (u daljem tekstu: „Aplikacija“) u vezi sa korišćenjem Aplikacije.',
      'Počinjanjem korišćenja Aplikacije Korisnik potvrđuje da se u potpunosti upoznao sa ovim Uslovima i da ih prihvata. U slučaju neslaganja, potrebno je prekinuti korišćenje Aplikacije.',
    ],
  },
  {
    heading: '1. Predmet i status Aplikacije',
    paragraphs: [
      'Aplikacija „Auto RS“ je informativna platforma (servis oglasa o automobilima) koja Korisnicima pruža tehničku mogućnost da postavljaju oglase za prodaju i izdavanje automobila, pronalaze vozila i međusobno stupaju u kontakt.',
      'Aplikacija NIJE strana u poslovima između Korisnika, ne nastupa kao prodavac, kupac, zakupodavac, posrednik, agent ili garant u poslovima. Svi poslovi se zaključuju i izvršavaju između Korisnika neposredno, na njihov sopstveni rizik i odgovornost.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      '• Aplikacija je namenjena licima starijim od 18 godina. Registracijom Korisnik potvrđuje svoju punoletnost.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Aplikacija primenjuje automatsku moderaciju (proveru rečnikom i pomoću tehnologija veštačke inteligencije). Moderacija ima pomoćni karakter i ne oslobađa Korisnika odgovornosti: prolazak provere ne znači odobrenje sadržaja od strane Aplikacije.',
    ],
  },
  {
    heading: '4. Prava na sadržaj',
    paragraphs: [
      'Objavljivanjem sadržaja Korisnik zadržava svoja prava na njega, ali Aplikaciji daje neisključivu besplatnu licencu za njegovo čuvanje, umnožavanje i prikazivanje drugim korisnicima u obimu neophodnom za rad servisa (uključujući u pregledima i u rezultatima pretrage).',
    ],
  },
  {
    heading: '5. Odsustvo garancija i ograničenje odgovornosti',
    paragraphs: [
      '• Aplikacija se pruža „takva kakva jeste“ i „prema dostupnosti“. Rukovalac ne garantuje neprekidan i bezgrešan rad servisa.',
      ...
      '• U najvećoj meri dozvoljenoj zakonom, Rukovalac ne odgovara za posrednu štetu, izmaklu dobit i gubitak podataka nastale u vezi sa korišćenjem Aplikacije.',
    ],
  },
  {
    heading: '6. Blokiranje i prekid pristupa',
    paragraphs: [
      'Rukovalac ima pravo da bez prethodnog obaveštenja ograniči, privremeno obustavi ili prekine pristup Korisnika Aplikaciji, kao i da ukloni ili sakrije sadržaj u slučaju kršenja ovih Uslova, zakonskih propisa ili prava trećih lica.',
    ],
  },
  {
    heading: '7. Izmena Uslova',
    paragraphs: [
      'Rukovalac ima pravo da menja ove Uslove. Nova verzija stupa na snagu od trenutka njenog objavljivanja u Aplikaciji. Pri bitnim izmenama Aplikacija obaveštava Korisnika i po potrebi traži ponovnu saglasnost.',
    ],
  },
  {
