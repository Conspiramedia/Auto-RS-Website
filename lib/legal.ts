...
const PRIVACY_RU: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '• На полное забвение: удалить аккаунт и все связанные с ним персональные данные самостоятельно — в профиле, разделом «Удаление аккаунта». Вместе с аккаунтом удаляются объявления, переписка и загруженные фотографии. Действие необратимо.',
...
const PRIVACY_SR: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '• Na potpuno brisanje: da sam obriše nalog i sve sa njim povezane lične podatke — u profilu, u odeljku «Brisanje naloga». Zajedno sa nalogom brišu se oglasi, prepiske i učitane fotografije. Radnja je nepovratna.',
