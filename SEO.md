...
**Открытых вопросов по отчёту не осталось.** Единственный пункт, не
покрытый ревизией, — соответствие `<h1>` заголовкам и уникальность
заголовков внутри витрин марок и моделей (проблема №14): это предмет
отдельной задачи, флагом текущей инвентаризации он не был.
