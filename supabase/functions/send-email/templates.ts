...
const DICT = {
  ...
  ru: {
    ...
    // «Отклонено», а не «не одобрено»: ровно тем же словом статус
    // назван в кабинете (my_status_rejected), и человек, перешедший
    // из письма по кнопке, обязан увидеть в списке то же самое.
    rejected_subject: 'Объявление отклонено',
    rejected_title: 'Объявление отклонено',
