...
export default async function Image({
  ...
  //
  // Снятые с публикации попадают сюда же. С миграции 0072 RPC отдаёт
  // их постороннему в урезанном виде (цены и фото недоступны), и без
  // этой проверки превью нарисовалось бы с «Договорная» вместо цены и
  // пустым местом вместо снимка. Признак постороннего — пустая витрина
  // продавца: владельцу и админу объявление приходит целиком.
  const withdrawn =
    car !== null &&
    car.status !== 'active' &&
    car.status !== 'sold' &&
