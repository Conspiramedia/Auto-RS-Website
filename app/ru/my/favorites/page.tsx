...
// /my/favorites. Проверку сессии задаёт layout кабинета.
//
...
// «Мой кабинет» — layout задаёт его один на всё поддерево. Человек с
...
// значение дало бы «Избранное | RS Auto» — с вертикальной чертой
